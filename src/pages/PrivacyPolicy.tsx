...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Summit Ledger</title>
        <meta name="description" content="Summit Ledger privacy policy. How we collect, use, and protect your personal data including CRM processing, cookies, security, and your rights." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://summitledger.com/privacy" />
      </Helmet>
          ...
          <div className="container mx-auto max-w-5xl px-4 lg:px-8 relative z-10 py-14 sm:py-20">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="font-body text-base text-muted-foreground max-w-3xl leading-relaxed">
                Summit Ledger is committed to protecting your privacy. This policy explains what information we collect, how we use it, the basis on which we process it, and the rights and controls you have over your data when using our website and services.
              </p>
