...
const LOGGED_FAQ = [
  { q: "Is theSilverStone Capital a registered investment manager?", a: "theSilverStone Capital operates under applicable regulatory frameworks with registered partners in key jurisdictions. Our structure is designed for international clients with appropriate legal opinions and compliance frameworks." },
...
const LoggedIn = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Learn Hub | theSilverStone Capital</title>
        <meta name="description" content="Your personal theSilverStone Capital learning hub. Master crypto, blockchain, and portfolio strategy with our educational resources." />
