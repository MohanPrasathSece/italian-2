...
const SECTIONS = [
  ...
  },
  {
    ...
    title: "15. Contact",
    body:
      "Questions, notices, or requests regarding these Terms should be directed to: Silver Stone Capital. Communications received through the above channels shall be deemed received upon confirmation from our systems.",
  },
];
...
const TermsConditions = () => {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | Silver Stone Capital</title>
        <meta name="description" content="Silver Stone Capital terms & conditions. Important disclaimers including cryptocurrency risk disclosure, no financial advice, no guaranteed returns, and limitation of liability." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://silverstonecapital.com/terms" />
      </Helmet>
          ...
          <div className="container mx-auto max-w-4xl px-4 lg:px-8 relative z-10 py-14 sm:py-20">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="font-body text-base text-muted-foreground max-w-3xl leading-relaxed">
                Please read these terms carefully before using the Silver Stone Capital website. They include important disclaimers, risk warnings, and limitations of liability. By accessing or using the Site, you agree to be bound by these Terms &amp; Conditions in full.
              </p>
