          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="font-body text-sm leading-relaxed text-white/70">
                Aethel Capital is a premier digital asset investment firm delivering institutional-grade cryptocurrency strategies, portfolio management, and secure custody for global investors.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <p className="font-body text-sm text-white/70">
                © {new Date().getFullYear()} Aethel Capital. All rights reserved.
              </p>
            </div>
